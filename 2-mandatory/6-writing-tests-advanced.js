...
*/
test("formatCourseworkResult returns the result for Xin", () => {
  let trainee = {
    name: "Xin",
    score: 63,
  };
...
*/
test("formatCourseworkResult when passed the no name trainee", () => {
  const trainee = {
    score: 90,
    age: 29
  };
...
*/
test("formatCourseworkResult returns the correct result for Aman", () => {
  const trainee = {
    name: "Aman",
    subjects: ["HTML", "CSS", "Databases"]
  };
